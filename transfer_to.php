...
<body>
	...
	<center>
		<div class="view">
			<br><br><h2 style=" font-size:45px;color:#006080;text-shadow: 2px 2px black;">Transfer Amount</h2>
	...
	<form action="user.php" method="post">
			<div class="buttons">
				<button class="btn btn-dark" type="submit" name="name" value="<?php echo $name1 ?>">Back</button>
			</div>
	</form>
</center>
</body>
